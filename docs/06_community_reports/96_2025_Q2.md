...
Another area of focus for PAL in Q2 was the vetting of vendors for the development of a comprehensive [ecosystem monitoring tool](/rfp/2501). The curators started reviewing the incoming applications on RFP 2501 and initiated conversations with the candidate suppliers to clarify the scope of delivery, the price, or other relevant aspects.
